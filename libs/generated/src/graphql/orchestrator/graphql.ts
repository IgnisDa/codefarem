...
export type CreateGoalInput = {
  ...
  questionIds: Array<Scalars['UUID']>;
  /** The start and end date for this goal */
  range: RangeInput;
};

/** The output object when creating a goal */
export type CreateGoalResultUnion = ApiError | IdObject;
...
export type MutationRoot = {
  ...
  addUserToClass: Scalars['Boolean'];
  /** Create a new goal */
  createGoal: CreateGoalResultUnion;
  /** Delete a class */
...
/** The GraphQL top-level mutation type */
export type MutationRootAddUserToClassArgs = {
  classId: Scalars['UUID'];
};
...
export type QueryRoot = {
  ...
  randomProfileAvatar: Scalars['String'];
...
/** The output object when creating a new user */
export type UpdateUserResultUnion = ApiError | IdObject;
...
export type CreateGoalMutation = { createGoal: { __typename: 'ApiError', error: string } | { __typename: 'IdObject', id: string } };
...
export type UpdateUserMutation = { updateUser: { __typename: 'ApiError', error: string } | { __typename: 'IdObject', id: string } };

export type AddUserToClassMutationVariables = Exact<{
  classId: Scalars['UUID'];
}>;


export type AddUserToClassMutation = { addUserToClass: boolean };
...
export type ClassDetailsQuery = { classDetails: { __typename: 'ApiError', error: string } | { __typename: 'ClassDetailsOutput', id: string, name: string, numGoals: number, numStudents: number, numTeachers: number } };
...
export type UserDetailsQuery = { userDetails: { __typename: 'ApiError', error: string } | { __typename: 'UserDetailsOutput', accountType: AccountType, profile: { email: string, username: string, profileAvatar: string } } };
...
export type RandomProfileAvatarQueryVariables = Exact<{ [key: string]: never; }>;


export type RandomProfileAvatarQuery = { randomProfileAvatar: string };
...
export const AddUserToClassDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AddUserToClass"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"classId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"addUserToClass"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"classId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"classId"}}}]}]}}]} as unknown as DocumentNode<AddUserToClassMutation, AddUserToClassMutationVariables>;
...
export const ClassDetailsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ClassDetails"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"joinSlug"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"classDetails"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"joinSlug"},"value":{"kind":"Variable","name":{"kind":"Name","value":"joinSlug"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ClassDetailsOutput"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"numGoals"}},{"kind":"Field","name":{"kind":"Name","value":"numStudents"}},{"kind":"Field","name":{"kind":"Name","value":"numTeachers"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ApiError"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"error"}}]}}]}}]}}]} as unknown as DocumentNode<ClassDetailsQuery, ClassDetailsQueryVariables>;
...
export const RandomProfileAvatarDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"RandomProfileAvatar"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"randomProfileAvatar"}}]}}]} as unknown as DocumentNode<RandomProfileAvatarQuery, RandomProfileAvatarQueryVariables>;