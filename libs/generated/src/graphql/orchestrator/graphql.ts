...
export type ClassDetailsQuery = { classDetails: { __typename: 'ApiError', error: string } | { __typename: 'ClassDetailsOutput', name: string, numGoals: number, numStudents: number, numTeachers: number } };
