...
export type ExecuteCodeForQuestionMutation = { executeCodeForQuestion: { __typename: 'ExecuteCodeError', error: string, step: ExecuteCodeErrorStep } | { __typename: 'ExecuteCodeForQuestionOutput', numTestCases: number, numTestCasesFailed: number, testCaseStatuses: Array<{ passed: boolean, userOutput: string, expectedOutput: string, time: { compilation: string, execution: string } }> } };
