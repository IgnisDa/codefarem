...
export namespace learning {
  ...
  export interface QuestionFolder extends std.$Object {
    "name": string;
    "class": Class;
    "parent"?: QuestionFolder | null;
  }
  export interface QuestionInstance extends std.$Object {
    "question": Question;
...
export interface types {
  ...
  "learning": {
    ...
    "QuestionFolder": learning.QuestionFolder;
    "QuestionInstance": learning.QuestionInstance;
